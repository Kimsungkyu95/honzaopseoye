            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="nav-link"
                            href="${pageContext.request.contextPath}/front?key=member&methodName=selectMemberByID&memberID=${loginId}">수정하기</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="nav-link"
                            href="${pageContext.request.contextPath}/front?key=member&methodName=selectProfileImageById&memberID=${loginId}">수정하기</a>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="nav-link"
                        href="${pageContext.request.contextPath}/front?key=member&methodName=selectExpById&memberID=${loginId}">확인하기</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="nav-link"
                            href="${pageContext.request.contextPath}/front?key=member&methodName=selectReviewList&memberID=${loginId}">리뷰보기</a>
                    </div>
                </div>
            </div>
